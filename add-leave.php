                                      ...
                                      <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="leave-type" name="leave-type" >
                                                    ...
                                                    <option  value="Time Off as a Gift">Time Off as a Gift</option>
                                                    <option  value="Vacation">Vacation</option>
                                                    <option  value="Study Leave">Study Leave</option>
                                                    <option  value="Half Pay Leave">Half Pay Leave</option>
                                                    <option  value="Childe Care Leave">Childe Care Leave</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="leave-cat" name="leave-cat" onchange="onsel(this);">
                                                    ...
                                                    <option  value="Half Day">A Week</option>
                                                    <option  value="Half Day">A Year</option>
